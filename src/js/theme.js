...
/* Preserve two-tone icon artwork instead of flattening detailed PNGs into masks. */
#quiz-browser .qb-library-tab[data-library-view="recent"]::before,
.weak-spots-menu-button::before,
[data-weak-spots-open]::before,
#quiz-restart::before,
[data-flag-restart]::before,
#qb-mobile-collapse-arrow {
    ...
    filter: grayscale(1) contrast(1.15) brightness(.52) !important;
}

#quiz-browser .qb-library-tab[data-library-view="recent"]::before {
    background-image: url('/assets/icons/clock.png') !important;
}

.weak-spots-menu-button::before,
[data-weak-spots-open]::before {
    background-image: url('/assets/icons/crosshair.png') !important;
}

#quiz-restart::before,
[data-flag-restart]::before {
    background-image: url('/assets/icons/restart.png') !important;
}

#qb-mobile-collapse-arrow {
    background-image: url('/assets/icons/up_arrow.png') !important;
}

#quiz-browser.qb-mobile-collapsed #qb-mobile-collapse-arrow {
    background-image: url('/assets/icons/down_arrow.png') !important;
}

html[data-smurdy-theme="dark"] #quiz-browser .qb-library-tab[data-library-view="recent"]::before,
html[data-smurdy-theme="dark"] .weak-spots-menu-button::before,
html[data-smurdy-theme="dark"] [data-weak-spots-open]::before,
html[data-smurdy-theme="dark"] #quiz-restart::before,
html[data-smurdy-theme="dark"] [data-flag-restart]::before,
html[data-smurdy-theme="dark"] #qb-mobile-collapse-arrow {
    filter: none !important;
}

/* Favorite stars: outlined when off, solid yellow when on. */
#quiz-browser .qb-library-tab[data-library-view="favorites"]::before,
#quiz-browser .qb-favorite::before {
    content: "☆" !important;
...
#quiz-browser .qb-favorite[aria-pressed="true"]::before {
    content: "★" !important;
    color: #d49a00 !important;
}

html[data-smurdy-theme="dark"] #quiz-browser .qb-favorite[aria-pressed="true"],
html[data-smurdy-theme="dark"] #quiz-browser .qb-favorite[aria-pressed="true"]::before {
    color: #ffd54f !important;
}

/* Flat dark-mode hierarchy: no barely-different slabs behind labels or list rows. */
html[data-smurdy-theme="dark"] .directory-card {
    background: transparent !important;
}

html[data-smurdy-theme="dark"] .directory-card:hover,
html[data-smurdy-theme="dark"] .directory-card:focus-visible {
    background: #252d33 !important;
}
`;
